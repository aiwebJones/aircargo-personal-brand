...
export default function PersonalSection() {
  return (
    <section className="py-32 bg-[#08121c]">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {beliefs.map((belief, index) => (
            <motion.div
              ...
              className="p-8 border border-white/5 hover:border-amberGold/20 transition-all duration-500"
            >
              {/* Header */}
              ...
              <ul className="space-y-4">
                {belief.items.map((item, i) => (
                  <li key={i} className="flex items-start gap-3 text-industrialGray/70 text-sm leading-relaxed">
