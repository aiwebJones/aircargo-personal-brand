...
export default function MethodologySection() {
  return (
    <section id="methodology" className="py-32 bg-[#08121c]">
        ...
        <div className="space-y-1">
          {methods.map((method, index) => (
            <motion.div
              ...
              className="group border-t border-white/5 hover:border-amberGold/20 transition-all duration-500"
            >
              <div className="py-12 grid md:grid-cols-12 gap-8 items-start">
                {/* Number */}
                <div className="md:col-span-1">
                  <span className="text-4xl font-bold text-white/10 group-hover:text-amberGold/30 transition-colors">
                    {method.number}
                  </span>
                </div>
                ...
                <div className="md:col-span-8">
                  <p className="text-industrialGray/60 leading-relaxed group-hover:text-industrialGray/80 transition-colors">
                    {method.description}
                  </p>
                </div>
              </div>
