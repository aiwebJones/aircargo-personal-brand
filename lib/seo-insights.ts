...
export const seoInsights: SeoInsight[] = [
  ...
  },
  {
    ...
    title: '中国各大机场到JNB约翰内斯堡空运：矿业急件路线怎么判断？',
    excerpt:
      '从全国主要航空口岸集货到JNB，不是先选一个最低机场价，而是比较国内集运、装载能力、中转、南非清关和矿区交付。',
    date: '2026-06-30',
    ...
    author: defaultAuthor,
    image: '/case-17t-1.jpg',
    keywords: ['JNB约翰内斯堡空运', '中国各大机场到JNB空运', '南非矿业设备空运', '南部非洲项目货'],
    template: 'generated',
    audience: ['南非矿业供应商', '工程设备工厂', '贸易商'],
    angle: '用全国集货、装载、清关和矿区交付四层判断回答高意向JNB询价。',
    sections: [
      {
        heading: '先判断JNB是不是正确入口',
        body: [
          'JNB适合南非本土项目货，也可以作为部分南部非洲项目的路线比较入口。矿山备件、工程设备、汽车零部件、工厂维修件和高价值急件，不能只比较每公斤价格；应先确认最终城市、停产窗口、清关主体和机场之后的交付责任。',
          'O.R. Tambo机场具备成熟的国际货运和全国道路连接条件，但这不代表每票南非货都应走JNB。最终现场在西开普或夸祖鲁-纳塔尔时，还要把CPT、DUR和JNB加内陆卡车的总时间、成本和装卸条件放在一起比较。',
        ],
        bullets: ['南非矿山停产急件', '工厂和工程设备备件', '高价值工业或汽车零部件', '需要主甲板判断的大件货'],
      },
      {
        heading: '全国集货不是把每个机场都写成直飞',
        body: [
          'EASCargo会按货源所在地比较华东PVG/HGH/NKG、华南CAN/SZX/HKG/HAK、华北和东北PEK/PKX/TSN/TAO、华中西部WUH/CGO/XIY/CTU/TFU/CKG，以及福建XMN/FOC等口岸。这些是起运比较点，不是固定直达航班或保证舱位。',
          '离工厂最近的机场不一定是总方案最优。普通尺寸货可以优先比较就近宽体腹舱和全球Hub中转；超高、超长或超重单件则要比较国内集卡到更强货机口岸、HAK/JNB可用容量信号，或LGG/BRU主甲板中转。最终选择取决于当票货的尺寸、重量、备货日期和中转接受确认。',
        ],
        bullets: ['就近口岸与强货机口岸比较', '国内集运成本和截货时间', '中转机场逐段接受确认', '不把公开航线写成固定承诺'],
      },
      {
        heading: '装载可行性先于运价',
        body: [
          'JNB大件询价最常见的错误，是只提供总重量，不提供每件长宽高、毛重、包装照片、叉车孔、吊点、重心和可倾斜方向。对项目货来说，一件超出舱门、轮廓或地板承重点，就可能让整套低价方案失效。',
          '报价时应至少形成三组可比较路线：标准宽体或普通中转、当前可核实的全货机路线、LGG/BRU主甲板中转。每组都要逐段确认机型和货物接受条件，不能因为某条公开航线存在，就推断当天有舱位或一定能装。',
        ],
        bullets: ['最长件和最重件', '舱门与主甲板轮廓', '地板承重和重心', '中转仓装卸与重新组板'],
      },
      {
        heading: '南非清关资料必须在起飞前对齐',
        body: [
          '南非税务局SARS要求进口商、出口商或其清关/注册代理在提交Goods Declaration前完成相应注册或许可。外国进口商通常需要指定一名位于南非的注册代理。询价阶段就应对齐进口商、海关代码、清关代理、HS Code、商业发票、装箱单和AWB资料。',
          '受限制商品可能需要主管部门签发的许可证、证书或Letter of Authority。二手设备、旧件、废料或废品可能受ITAC进口管制。是否受控必须按具体品名和税号确认，不能用“矿山备件”这一笼统描述替代产品合规判断。',
        ],
        bullets: ['进口商或南非注册代理', 'Goods Declaration资料一致', 'SARS/NRCS/ITAC适用性', '新品、旧件或返修件状态'],
      },
      {
        heading: '报价要写清机场之后谁负责',
        body: [
          'JNB到港不等于项目完成。报价必须明确是机场到机场、包含清关协调、清关后机场提货，还是继续送到矿区、工厂或跨境项目现场。卡车车型、保税或过境安排、卸货设备、预约窗口和现场联系人都会影响真实到货结果。',
          '一份可执行的JNB报价，应同时展示起运口岸逻辑、主路线与备选路线、未确认条件、清关资料缺口、费用边界和最终交付边界。这样客户比较的不是一个看似便宜的公斤价，而是哪套方案最可能在停产期限前完成交付。',
        ],
        bullets: ['JNB机场交接边界', '南非境内或跨境卡车', '矿区预约和卸货工具', '主路线、备选路线与未确认项'],
      },
    ],
    checklist: ['具体英文品名和 HS Code', '每件长宽高与毛重', '包装照片、叉车孔和吊点', '货物所在地与备货日期', '最终城市或矿区地址', '最晚到货时间及停产影响', '进口商和清关代理资料', '是否为旧件、返修件或受控产品'],
    relatedRoutes: [
      { label: 'JNB 航线页', href: '/africa-air-freight/jnb/' },
      { label: 'JNB 南非清关资料', href: '/insights/south-africa-jnb-sars-nrcs-loa-air-freight-clearance/' },
      { label: 'HAK-JNB全货机路线判断', href: '/insights/haikou-johannesburg-freighter-china-africa-project-cargo/' },
      { label: '非洲项目货询价 Agent', href: '/tools/africa-project-cargo-rfq/?source=jnb-mining-guide' },
      { label: 'CPT 开普敦', href: '/africa-air-freight/cpt/' },
      { label: 'DUR 德班', href: '/africa-air-freight/dur/' },
    ],
    sources: [
      { label: 'Airports Company South Africa: About O.R. Tambo International Airport', href: 'https://www.airports.co.za/airports/or-tambo-international-airport/the-airport/about-or-tambo' },
      { label: 'SARS: Importer registration and registered-agent requirements', href: 'https://www.sars.gov.za/customs-and-excise/registration-licensing-and-accreditation/importers/' },
      { label: 'SARS: Goods Declaration requirements', href: 'https://www.sars.gov.za/customs-and-excise/goods-declaration/' },
      { label: 'SARS: Prohibited and restricted goods', href: 'https://www.sars.gov.za/customs-and-excise/prohibited-restricted-and-counterfeit-goods/' },
      { label: 'South African Government: ITAC import permits for controlled and used goods', href: 'https://www.gov.za/services/import/import-permit-general-goods' },
    ],
  },
  {
